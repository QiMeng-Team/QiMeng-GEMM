...
The high-performance GEMM code generated by leveraging LLMs for QiMeng-GEMM is located in the CUDA directory and the RISC-V directory. By using the code in the above-mentioned directories, one can quickly obtain high-performance GEMM executable files on the supported hardware platforms.
