...
"vle32.v       v0,    (%[PA])  \n\t"\
"vle32.v       v1,    (t4)  \n\t"\
"vfmacc.vf  v12,  ft0,  v0  \n\t"\
"vfmacc.vf  v13,  ft0,  v1  \n\t"\
"vfmacc.vf  v14,  ft1,  v0  \n\t"\
"vfmacc.vf  v15,  ft1,  v1  \n\t"\
"vfmacc.vf  v16,  ft2,  v0  \n\t"\
"vfmacc.vf  v17,  ft2,  v1  \n\t"\
"vfmacc.vf  v18,  ft3,  v0  \n\t"\
...
"addi       t2,    t2, 4*4  \n\t"\
"addi       t3,    t3, 4*4  \n\t"\
"vfmacc.vf  v12,  ft4,  v2  \n\t"\
"vfmacc.vf  v13,  ft4,  v3  \n\t"\
"vfmacc.vf  v14,  ft5,  v2  \n\t"\
"vfmacc.vf  v15,  ft5,  v3  \n\t"\
"vfmacc.vf  v16,  ft6,  v2  \n\t"\
"vfmacc.vf  v17,  ft6,  v3  \n\t"\
"vfmacc.vf  v18,  ft7,  v2  \n\t"\
"vfmacc.vf  v19,  ft7,  v3  \n\t"\
"vle32.v       v2,    (%[PA])  \n\t"\
"vle32.v       v3,    (t4)  \n\t"\
"addi       %[PA],    %[PA], 16*4  \n\t"\
"addi       t4,    t4,       16*4  \n\t"\
...
"vfmacc.vf  v11,  ft1,  v0  \n\t"\
"vfmacc.vf  v12,  ft2,  v0  \n\t"\
"vfmacc.vf  v13,  ft3,  v0  \n\t"\
"addi       %[PB],    %[PB], 4*4  \n\t"\
"addi       t1,    t1, 4*4  \n\t"\
"addi       t2,    t2, 4*4  \n\t"\
"addi       t3,    t3, 4*4  \n\t"\
...
"addi       t2,    t2, 4*4  \n\t"\
"addi       t3,    t3, 4*4  \n\t"\
"vfmacc.vf  v10,  ft4,  v1  \n\t"\
"vfmacc.vf  v11,  ft5,  v1  \n\t"\
"vfmacc.vf  v12,  ft6,  v1  \n\t"\
"vfmacc.vf  v13,  ft7,  v1  \n\t"\
"vle32.v       v1,    (%[PA])  \n\t"\
"addi       %[PA],    %[PA], 8*4  \n\t"\
"flw       ft4,    (%[PB])  \n\t"\
"flw       ft5,    (t1)  \n\t"\
