...
"vfmacc.vv  v8,   v0, v16  \n\t"\
"vfmacc.vv  v9,   v0, v20  \n\t"\
"vfmacc.vv  v10,   v0, v24  \n\t"\
"vfmacc.vv  v11,   v0, v28  \n\t"\
"vse.v      v8,   (%[C0])   \n\t"\
"vse.v      v9,   (%[C1])   \n\t"\
"vse.v      v10,   (%[C2])   \n\t"\
"vse.v      v11,   (%[C3])   \n\t"\
...
"vfmacc.vv  v8,   v0, v17  \n\t"\
"vfmacc.vv  v9,   v0, v21  \n\t"\
"vfmacc.vv  v10,   v0, v25  \n\t"\
"vfmacc.vv  v11,   v0, v29  \n\t"\
"vse.v      v8,   (%[C0])   \n\t"\
"vse.v      v9,   (%[C1])   \n\t"\
"vse.v      v10,   (%[C2])   \n\t"\
"vse.v      v11,   (%[C3])   \n\t"\
...
"vfmacc.vv  v8,   v0, v18  \n\t"\
"vfmacc.vv  v9,   v0, v22  \n\t"\
"vfmacc.vv  v10,   v0, v26  \n\t"\
"vfmacc.vv  v11,   v0, v30  \n\t"\
"vse.v      v8,   (%[C0])   \n\t"\
"vse.v      v9,   (%[C1])   \n\t"\
"vse.v      v10,   (%[C2])   \n\t"\
"vse.v      v11,   (%[C3])   \n\t"\
...
"vfmacc.vv  v8,   v0, v19  \n\t"\
"vfmacc.vv  v9,   v0, v23  \n\t"\
"vfmacc.vv  v10,   v0, v27  \n\t"\
"vfmacc.vv  v11,   v0, v31  \n\t"\
"vse.v      v8,   (%[C0])   \n\t"\
"vse.v      v9,   (%[C1])   \n\t"\
"vse.v      v10,   (%[C2])   \n\t"\
"vse.v      v11,   (%[C3])   \n\t"\
...
:"t0", "t4", "t5", "t6", "t1", "t2", "t3", "ft11", "ft0", "ft1", "ft2", "ft3", "ft4", "ft5", "ft6", "ft7", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20", "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29", "v30", "v31"
...
"addi       %[PB],    %[PB], 2*4  \n\t"\
"addi       t1,    t1, 2*4  \n\t"\
"vfmacc.vv  v12,  v10,  v4  \n\t"\
"vfmacc.vv  v13,  v10,  v5  \n\t"\
"vfmacc.vv  v14,  v10,  v6  \n\t"\
"vfmacc.vv  v15,  v10,  v7  \n\t"\
"vfmacc.vv  v16,  v11,  v4  \n\t"\
"vfmacc.vv  v17,  v11,  v5  \n\t"\
"vfmacc.vv  v18,  v11,  v6  \n\t"\
"vfmacc.vv  v19,  v11,  v7  \n\t"\
"vle.v       v4,    (%[PA])  \n\t"\
"vle.v       v5,    (t2)  \n\t"\
"vle.v       v6,    (t3)  \n\t"\
"vle.v       v7,    (t4)  \n\t"\
...
:[ALPHA]"f"(alpha), [BK]"r"(bk)\
:"t0", "t2", "t3", "t4", "t1", "ft11", "ft0", "ft1", "ft2", "ft3", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19"
...
:[ALPHA]"f"(alpha), [BK]"r"(bk)\
:"t0", "t1", "t2", "t3", "ft11", "ft0", "ft1", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13"
